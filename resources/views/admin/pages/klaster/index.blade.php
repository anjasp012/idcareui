                ...
                <div class="row">
                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between w-100">
                                    <div class="d-flex justify-content-between w-100">
                                        ...
                                        <form action="{{ route('admin.pages.klaster.updateBg') }}" method="POST"
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between w-100">
                                    <div class="d-flex justify-content-between w-100">
                                        <h4>Content</h4>
                                        <a href="{{ route('admin.pages.klaster.edit') }}" class="btn btn-primary">Edit</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="{{ route('admin.klaster.index') }}" class="btn btn-primary">Kelola Daftar
                                    Klaster</a>
                            </div>
                        </div>
                    </div>
