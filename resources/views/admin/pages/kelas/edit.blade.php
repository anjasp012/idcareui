                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.pages.kelas.update') }}" method="POST">
                                    @csrf
                                    @method('PUT')
...
@push('script')
    ...
    {{-- <script src="{{ asset('stisla/dist/assets/modules/ckeditor/pluigins/justify/plugin.js') }}"></script> --}}
    {{-- <script src="{{ asset('stisla/dist/assets/modules/ckeditor/pluigins/uploadfile/plugin.js') }}"></script> --}}
