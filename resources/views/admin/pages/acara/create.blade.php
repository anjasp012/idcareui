                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.pages.' . strtolower($title) . '.store') }}" method="POST"
                                    ...
                                    <div class="form-group row mb-4">
                                        <label
                                            class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Lampiran</label>
                                        <div class="col-sm-12 col-md-7">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <input class="form-control" type="text" placeholder="Nama Lampiran"
                                                        name="lampiran[0][nama]">
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="file" name="lampiran[0][file]" id="image-upload" />
                                                </div>
                                            </div>
                                            @error('lampiran')
                                                <small class="text-danger">{{ $message }}</small>
